...
do
    ...
    then
        srun -p gpu -t 10:00:00 --mem-per-cpu 1 --gres=gpu:1 -J caps_${data}_l1_1 -o caps_${data}_l1_1.out -e caps_${data}_l1_1.err python train.py --model caps --data ${data} --epochs 30 --batch-size 100 --regularizer l1 --regularizer-weight 1 --name caps_${data}_30_l1_1 --save-freq 1 --tensorboard &
    ...
    then
        srun -p gpu -t 10:00:00 --mem-per-cpu 1 --gres=gpu:1 -J caps_${data}_l2_1 -o caps_${data}_l2_1.out -e caps_${data}_l2_1.err python train.py --model caps --data ${data} --epochs 30 --batch-size 100 --regularizer l2 --regularizer-weight 1 --name caps_${data}_30_l2_1 --save-freq 1 --tensorboard &
    ...
    then
        srun -p gpu -t 10:00:00 --mem-per-cpu 1 --gres=gpu:1 -J caps_${data}_l21_1 -o caps_${data}_l21_1.out -e caps_${data}_l21_1.err python train.py --model caps --data ${data} --epochs 30 --batch-size 100 --regularizer l21 --regularizer-weight 1 --name caps_${data}_30_l21_1 --save-freq 1 --tensorboard &
    ...
    then
        srun -p gpu -t 10:00:00 --mem-per-cpu 1 --gres=gpu:1 -J caps_${data}_op_1 -o caps_${data}_op_1.out -e caps_${data}_op_1.err python train.py --model caps --data ${data} --epochs 30 --batch-size 100 --regularizer operator_norm --regularizer-weight 1 --name caps_${data}_30_op_1 --save-freq 1 --tensorboard &
